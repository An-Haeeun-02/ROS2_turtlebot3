...
: ${AMENT_CURRENT_PREFIX:="/home/hae/robot_ws/src/install/robot_action_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_action_pkg/environment/library_path.sh"
